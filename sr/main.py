...
TABLE_J1 = PART_16 + "/chapter_J.html"
...
def run(
    ...
    snomed, concepts, cid_lists, name_for_cid, retired = process_source_data(
        cid_paths, table_o1, table_d1, table_j1
    )
...
# FIXME
def write_retired_file(codes) -> None:
    """Write the retired code data to file.

    Some retired codes have no replacement.
    ...
    LOGGER.info(f"Writing data to '{RETIRED_FILE}'")

    with open(RETIRED_FILE, "w", encoding="utf8") as f:
        f.writelines(
            [
                f"# Auto-generated by pydicom-data-sr\n",
                "# -*- coding: utf-8 -*-\n",
        ...
        f.write("retired: Dict[str, Dict[str, str]] = {}\n")
